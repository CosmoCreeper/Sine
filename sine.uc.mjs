...
const Sine = {
    ...
    async initMarketplace() {
        ...
        const settingPrefs = [
            ...
            {
                "type": "checkbox",
                "property": "sine.enable-tangent",
                "label": "Enable the developer extension, Tangent (experimental)."
            },
            {
                "type": "text",
                "label": "**Editor**",
                "margin": "10px 0 15px 0",
                "size": "20px",
                "conditions": [{"if":{"property":"sine.enable-tangent","value":true}}],
                "id": "sine.editor.viewport-id"
            },
            {
                "type": "text",
                "label": "**Updates**",
