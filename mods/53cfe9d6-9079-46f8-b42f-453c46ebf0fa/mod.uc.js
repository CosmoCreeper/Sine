...
// @ignorecache
// @name           TabGrpsByrwx
// @namespace      animatedfoldericonsbyrwx
// @description    helps in making icon of tab groups animated
// @version        1.7b
// ==/UserScript==
...
const UC_API = require("chrome://userchromejs/content/uc_api.sys.mjs");

(function () {
 if (UC_API.Prefs.get("arcline.tab.grps").exists() && UC_API.Prefs.get("arcline.tab.grps")["value"] === 1) {
   if (window.Folder) {
