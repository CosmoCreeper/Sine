...
ruleTester.run("use-cc-etc", rule, {
  ...
  invalid: [
    invalidCode("let foo = Components.classes['bar'];", "classes", "Cc", "let foo = Cc['bar'];"),
    invalidCode("let bar = Components.interfaces.bar;", "interfaces", "Ci", "let bar = Ci.bar;"),
    invalidCode(
    ...
    invalidCode("Components.utils.reportError('fake');", "utils", "Cu", "Cu.reportError('fake');"),
  ],
});
