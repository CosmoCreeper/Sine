  ...
  invalid: [
    {
      ...
      errors: callError(),
      filename: "test.sys.mjs",
      output: 'import { XPCOMUtils } from "resource://gre/modules/XPCOMUtils.sys.mjs"',
    },
    {
      ...
      errors: callError(),
      filename: "test.sys.mjs",
      output: 'import { XPCOMUtils as foo } from "resource://gre/modules/XPCOMUtils.sys.mjs"',
    },
    {
      ...
      errors: callError(),
      filename: "test.sys.mjs",
      output: 'import { foo, XPCOMUtils } from "resource://gre/modules/XPCOMUtils.sys.mjs"',
    },
  ],
});
