...
ruleTester.run("balanced-listeners", rule, {
  valid: [
    "elt.addEventListener('event', handler);" + "elt.removeEventListener('event', handler);",
    ...
    "elt.addEventListener('event', handler);" + "elt.removeEventListener('event', handler, false);",

    "elt.addEventListener('event', handler, false);" + "elt.removeEventListener('event', handler);",
  ...
  invalid: [
    error("elt.addEventListener('click', handler, false);", "removeEventListener", "click"),
