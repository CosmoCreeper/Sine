 ...
 *   duplicates the valid-services rule, the checks here require an objdir and a manual run. This
 *   Source Code Form is subject to the terms of the Mozilla Public License, v. 2.0. If a copy of
